...
//   return (
//     <Container onMouseEnter={()=> setIsHoverd(true)} onMouseLeave={()=>setIsHoverd(false)}>
          ...
          <div className="info-container flex column">
            ...
            <div className="icons flex j-between">
              <div className="controls flex">
                ...
                <RiThumbUpFill title="Like" />
                <RiThumbDownFill title="Dislike" />
                {isLiked ? <BsCheck title="Remove From List" onClick={()=>dispatch(removeFromLikedMovies({movieId:movieData.id, email}))}/> : <AiOutlinePlus title="Add To My List" onClick={addToList}/>}
              </div>
              <div className="info">
                <BiChevronDown title="More Info" />
              </div>
